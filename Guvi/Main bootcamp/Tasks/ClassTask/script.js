...
function removeData() {
    if (flag === true) {
        ...
        table.remove();
        document.getElementById('change').removeEventListener('click', function () {
            updatedata(id)
        });
        document.getElementById('delete').removeEventListener('click', function () {
            deletedata(id)
        });
    }
...
// change.setAttribute('onclick', 'updatedata(id)')
// Delete.setAttribute('onclick', 'deletedata(id)')
...
async function editdata(id) {
    ...
    change.classList.toggle('change-display');
    Delete.classList.toggle('delete-display');
...
async function updatedata(id) {
    ...
    if (proceed) {
        ...
        removeData();
        fetchdata();
        document.getElementById('change').classList.toggle('change-display');
        document.getElementById('delete').classList.toggle('delete-display');
...
async function deletedata(id) {
    ...
    if (proceedDelete) {
        fetch("https://60ebd2d8e9647b0017cdde36.mockapi.io/users/" + sid.join(""), {
            method: "DELETE"
        })
        removeData();
        fetchdata();
